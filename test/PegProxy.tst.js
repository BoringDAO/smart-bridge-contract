...
describe("PegSwapPair contract", function () {
    ...
    beforeEach(async function () {
        ...
        const DAIBoringToken = await ethers.getContractFactory("BoringToken");
        borDAI = await DAIBoringToken.deploy("Boring DAI token", "BoringDAI");
    ...
    //     await expect(daiPair.swap(owner.address, true)).to.be.revertedWith(
    ...
    //   ).to.be.revertedWith("PegSwap: not support this token");
    ...
    //   await pegSwap.setPegProxy(owner.address);

...
interface WrapTokenInterface extends ethers.utils.Interface {
  functions: {
  ...
  decodeFunctionResult(functionFragment: "underToken", data: BytesLike): Result;
...
export class WrapToken extends BaseContract {
  ...
  functions: {
    ...
    underToken(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ...
    underToken(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    underToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
